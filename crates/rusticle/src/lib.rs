...
//! - **`imagequant`** — Default fallback quantizer when the quality-gated LUT fast path is not
//!   accepted. High-quality color quantization via imagequant.
...
//!   chain using the Wu fallback quantizer.
